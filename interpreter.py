...
rotation = 1
result = ""
single_step_enabled = True  # Variable to store the state of the Single Step toggle button
...
def open_gui():
    ...
    if gui_visible:
        ...
        single_step_frame = tk.Frame(debug_gui)
        single_step_frame.pack(padx=10, pady=10)
        single_step_var = tk.BooleanVar(value=single_step_enabled)
        single_step_button = tk.Checkbutton(single_step_frame, text="Single Step", variable=single_step_var)
        single_step_button.grid(row=0, column=0, padx=5, pady=5)
